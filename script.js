...
// For this Calculator App,First, make the clear screen button functional, so you can use it to clear the screen when you click other buttons. NB: Codes read from top to bottom chronologically.What ever code you write at the beging of your coding, will be read first and will affect subsequent codes if needed within the new code.
